...
from config import CORPUS_SIZE, GENERATOR_SELECTOR, NUM_PREFIX, NUM_SUFFIX, NUM_WORDS
...
class rvMutator:
    def __init__(self, max_data_seeds=100, corpus_size=CORPUS_SIZE, no_guide=False):
